...
@section('content')
<h4>Tambah Tugas Magang</h4>
	{{ link_to('tugas', 'Kembali', ['class' => 'btn btn-default btn-sm']) }}
	{!! Form::open(['url' => 'tugas', 'class' => 'form']) !!}
		...
		<div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
			{!! Form::label('status','Status:', ['class' => 'control-label']) !!}
					<div class="radio">
						<label>
							{!! Form::radio('status','B',true) !!}Mulai
						</label>
					</div>
		...
		<div class="form group">
			{!! Form::submit('Tambah Tugas Magang', ['class' => 'btn btn-primary form-control']) !!}
		</div>
	{!! Form::close() !!}
@endsection