...
<h4>Tambah Profil</h4>
	...
	{!! Form::open(['url' => 'profil', 'class' => 'form']) !!}
		...
		{!! Form::label('id_jurusan','Jurusan / Bidang Keahlian :', ['class' => 'control-label']) !!}
			@if(count($list_jurusan) > 0)
				{!! Form::select('id_jurusan', $list_jurusan, null, ['class' => 'form-control', 'id' => 'id_jurusan', 'placeholder' =>'-- Pilih Jurusan / Bidang keahlian --']) !!}
			@else
		...
		<div class="form group">
			{!! Form::submit('Tambah Profil Magang', ['class' => 'btn btn-primary form-control']) !!}
		</div>
	{!! Form::close() !!}
@endsection